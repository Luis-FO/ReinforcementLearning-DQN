...
(BASE_DIR / "VideosPendulum").mkdir(parents=True, exist_ok=True)
...
dqn_env = RecordVideo(dqn_env, video_folder=f"{BASE_DIR}/VideosPendulum", name_prefix="Pendulum-dqn_train_v1", episode_trigger=segmented_limit_trigger)
